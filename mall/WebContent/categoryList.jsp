            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 text-center">
                    <div class="section-heading">
                        ...
                        <a href="<%=request.getContextPath()%>/insertCategoryForm.jsp">카테고리 추가</a>
                    </div>
                </div>
            </div> <!-- / .row -->
		...
		<tbody>
			...
			%>
				<tr>
					...
					<td><a type="button" href="<%=request.getContextPath()%>/category/deleteCategoryAction.jsp?categoryName=<%=ca.getCategoryName()%>"><button type="button" class="btn btn-outline-success btn-circled">삭제</button></a></td>
				</tr>
			<%
				}
			%>
