        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-12 col-12 text-center">
                <div class="page-banner-content">
                    <h1 class="display-4 font-weight-bold">insertLoginManagerForm</h1>
                </div>
            </div>
        </div> <!-- / .row -->
    </div> <!-- / .container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                   <!-- form message -->
                    ...
                    <!-- end message -->
                    <!-- Contacts Form -->
                    <form class="contact_form" action="<%=request.getContextPath()%>/manager/insertManagerAction.jsp" method="post">
                        <div class="row">
                            <!-- Input -->
                        ...
                        <div class="">
                           <input name="submit" type="submit" class="btn btn-primary btn-circled" value="Register manager">
